    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8">
          <h1 className="text-3xl font-bold mb-6 text-gray-900">Upcoming Webinars</h1>
          {webinars.length === 0 ? (
            <div className="text-center py-12">
              <p className="text-gray-600 text-lg">No webinars scheduled yet.</p>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {webinars.map((webinar) => {
                ...
                return (
                  <div key={webinar.id} className="bg-white rounded-lg shadow hover:shadow-lg transition-shadow p-6">
                    ...
                    {isPast && (
                      <p className="text-sm text-gray-500">This webinar has passed</p>
                    )}
                  </div>
                );
              })}
