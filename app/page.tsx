  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white">
          ...
          <div className="relative container mx-auto px-4 py-24 md:py-32">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  href="/courses"
                  className="bg-white text-primary-600 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-blue-50 transition-colors shadow-lg"
                >
                  Explore Courses
                </Link>
                <Link
                  href="/shop"
                  className="bg-action-500 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-action-600 transition-colors shadow-lg border-2 border-white"
                >
                  Shop Products
                </Link>
              </div>
          ...
          <section className="py-16 bg-primary-50">
            <div className="container mx-auto px-4">
              ...
              <div className="text-center mt-8">
                <Link
                  href="/shop"
                  className="inline-block bg-action-500 text-white px-8 py-3 rounded-lg font-semibold hover:bg-action-600 transition-colors shadow-lg"
                >
                  View All Products
                </Link>
              </div>
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              ...
              <div className="text-center p-6">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">Teaching Resources</h3>
                <p className="text-gray-600">
        ...
        {/* CTA Section */}
        <section className="py-16 bg-gradient-to-r from-primary-600 via-purple-600 to-purple-700 text-white">
